...
export default function Page() {
  ...
  <main className="page" id="main">
    <section className="page-hero content-frame" data-index="03">
      ...
      <p className="page-lead">Каждая отрасль создаёт собственный профиль риска. Мы переводим его в конструкцию, материал, фурнитуру и сценарий использования комплекта.</p>
    </section>
