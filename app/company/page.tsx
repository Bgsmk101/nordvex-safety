...
export default function Page() {
  ...
  <main className="page" id="main">
    <section className="page-hero content-frame" data-index="05">
      ...
      <p className="page-lead">NORDVEX — вымышленный промышленный бренд, созданный как демонстрация того, каким может быть современный сайт производителя СИЗ: точным, содержательным и без визуального шума.</p>
    </section>
    <section className="section content-frame">
      <div className="section-head reveal">
        ...
        <div>
          ...
          <p className="section-intro">Мы проектируем не вокруг моды и не вокруг каталожной фотографии. Отправная точка — рабочее действие, физическая нагрузка и конкретный риск.</p>
        </div>
      </div>
